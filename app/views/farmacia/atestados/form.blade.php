...
<fieldset ng-app="App" ng-controller="AtestadoCtrl">
    ...
    <div class="col-md-12">
      ...
      <div class="form-group col-md-6">
          ...
          <div class="col-md-6">
            {{ Form::text('inicio_afastamento', null, array('class'=>'form-control', 'placeholder'=>'Inicio do Afastamento') ) }}
          </div>
          <div class="col-md-6">
            {{ Form::text('fim_afastamento', null, array('class'=>'form-control', 'placeholder'=>'Fim do Afastamento') ) }}
          </div>
      </div>
    </div>

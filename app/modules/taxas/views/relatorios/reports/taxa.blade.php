...
class TaxaView extends RelatorioController {
	...
	function Dados($corretor) {
		...
		if (!empty($taxas[1])) {
			...
			$this->Cell(90, 5, utf8_decode('DESCRIÇÃO'), 1, 0, "L", 1);
			$this->Cell(25, 5, utf8_decode('QTDE'), 1, 0, "C", 1);
			$this->Cell(25, 5, utf8_decode('PESO'), 1, 0, "C", 1);
			$this->Cell(25, 5, utf8_decode('RECEBER'), 1, 0, "C", 1);
			$this->Cell(25, 5, utf8_decode('PAGAR'), 1, 0, "C", 1);
			$this->Ln();
			...
			$this->Cell(90, 5, 'TOTAIS', 1, 0, "C", 1);
			$this->Cell(25, 5, number_format($totalQtd, 0, ',', '.'), 1, 0, "C", 1);
			$this->Cell(25, 5, number_format($totalPeso, 2, ',', '.'), 1, 0, "C", 1);
			$this->Cell(25, 5, 'R$ '.number_format($totalReceber, 2, ',', '.'), 1, 0, "R", 1);
			$this->Cell(25, 5, 'R$ '.number_format($totalPagar, 2, ',', '.'), 1, 0, "R", 1);
		...
		$this->Cell(45, 5, 'R$ '.number_format($totalPagar, 2, ',', '.'), 'TB', 0, "R", 0);
		$this->Ln();

		$this->Cell(45, 5, 'SALDO', 'TB', 0, "L", 1);
		$this->Cell(45, 5, 'R$ '.number_format($totalReceber-$totalPagar, 2, ',', '.'), 'TB', 0, "R", 1);
		$this->Ln();
